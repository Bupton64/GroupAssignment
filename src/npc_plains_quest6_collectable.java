...
public class npc_plains_quest6_collectable extends NPC{


    npc_plains_quest6_collectable (int posX, int posY){
        setName("Dusty Envelope");
        spriteSheet = loadImage("Image/crystal.png");
    ...
    public void initDialogue() {
        Dialogue d1 = new Dialogue(null,true,true,"Take the dusty envelope from behind the picture frame?","","","");
        listOne = d1;
    }
