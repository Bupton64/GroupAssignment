...
public class finalCutscene extends extraFunctions{
    ...
    finalCutscene(){
        ...
        change = false;
        DjikstraPosY = 500;
        backgroundFight = loadImage("Image/bossFight.png");
        backgroundSevar = loadImage("Image/plains_E5.png");       //PLACEHOLDER
        smokeSheet = loadImage("Image/smoke.png");
        spritesheet = loadImage("Image/chara1.png");
        spritesheet2 = loadImage("Image/chara2.png");
        ...
        spritesheet3 = loadImage("Image/military2.png");
        villagers[0] = subImage(spritesheet3,52,144,56,72);      //D8
        spritesheet4 = loadImage("Image/chara5.png");
        ...
        spritesheet5 = loadImage("Image/chara4.png");
        ...
        spritesheet6 = loadImage("Image/chara3.png");
