...
public class Combat extends extraFunctions{
    ...
    public void drawEnemyNamePlate(Graphics2D g){
        ...
        //replace circle with portrait later
        changeColor(white,g);
        drawText(580,23,enemy.getName(),textFont,20,g);
...
//        }
    ...
    public void drawEnemy(Graphics2D g) {
        ...
        } else if(enemy.getName().equals("Priest") || enemy.getName().equals("Razuul")|| enemy.getName().equals("Valliard") || enemy.getName().equals("Vampire")) {
