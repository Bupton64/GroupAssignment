    ...
    public void drawMenu(Graphics2D g) {
        if (chaMenu) {
            ...
            if ((player1.getInventory()[index].getName() != "Potion") && (player1.getInventory()[index].getName() != "Speed Potion")) {
                ...
                drawBoldText(680, 105, Integer.toString(player1.getAttack()), "Felix Titling", 18, g);
                drawBoldText(680, 105 + 30, Integer.toString(player1.getDefense()), "Felix Titling", 18, g);
                drawBoldText(680, 105 + 60, Integer.toString(player1.getStrength()), "Felix Titling", 18, g);
                drawBoldText(680, 105 + 90, Integer.toString(player1.getSpeed()), "Felix Titling", 18, g);
                drawBoldText(680, 105 + 120, Integer.toString(player1.getLuck()), "Felix Titling", 18, g);
