        ...
        if (equMenu) {
            if(player1.getInventory()[index].isEquippable() == false){
                ...
                for(int i =0; i<125; i+=25) {
                    drawLine(60, 131+i, 450, 131+i, 2, g);
                }
                ...
                for (int i = 0; i < player1.getInventorySize(); i++) {
                    ...
                    if ((player1.getInventory()[i].isEquippable())) {
                        drawBoldText(575, 125 + (20 * (i-num)), player1.getInventory()[i].getName(), "Felix Titling", 12, g);
                    }else{
                        num++;
                    }
                }
                ...
                if (player1.getInventory()[index].isEquippable()) {
                    ...
                    for (int i = 0; i < player1.getEquipmentSize(); i++) {
                        ...
                        } else if ((i == player1.getEquipmentSize() - 1)&&!isWeapon) {
                            changeColor(blue, g);
